...
export const NewsletterSignup = () => {
  ...
  return (
    <>
      <Button size="lg" onClick={toggleModal} style={{ margin: "auto" }}>
        Newsletter Signup
      </Button>
      <Modal isOpen={isModalOpen} onRequestClose={toggleModal}>
        <>
          ...
          <form
            ref={formRef}
            method="post"
            action="https://givebackcincinnati.us12.list-manage.com/subscribe/post?u=160bf2c9daa8af34307358b18&amp;id=0992f3a90c&amp;f_id=00d941e0f0"
          >
            {EmailSignupSchema ? (
              <DynamicForm
